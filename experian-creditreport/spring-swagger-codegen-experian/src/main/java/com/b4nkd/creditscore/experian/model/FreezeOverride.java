...
public class FreezeOverride   {
  ...
  private String secondaryApplFreezeOverrideCode = null;

  public FreezeOverride primaryApplFreezeOverrideCode(String primaryApplFreezeOverrideCode) {
  ...
  **/
  ...
  public FreezeOverride secondaryApplFreezeOverrideCode(String secondaryApplFreezeOverrideCode) {
    this.secondaryApplFreezeOverrideCode = secondaryApplFreezeOverrideCode;
    return this;
  }

  /**
   * This is the freeze override code for the secondary applicant Used when a consumer has authorized the client to access his or her frozen file and has provided the client with his or her pass code. This passcode is to be provided to Experian so that Experian can override the freeze and return credit data for the consumer back to the client.
   * @return secondaryApplFreezeOverrideCode
  **/
  @ApiModelProperty(value = "This is the freeze override code for the secondary applicant Used when a consumer has authorized the client to access his or her frozen file and has provided the client with his or her pass code. This passcode is to be provided to Experian so that Experian can override the freeze and return credit data for the consumer back to the client.")
  
    public String getSecondaryApplFreezeOverrideCode() {
    return secondaryApplFreezeOverrideCode;
  }

  public void setSecondaryApplFreezeOverrideCode(String secondaryApplFreezeOverrideCode) {
    this.secondaryApplFreezeOverrideCode = secondaryApplFreezeOverrideCode;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FreezeOverride freezeOverride = (FreezeOverride) o;
    return Objects.equals(this.primaryApplFreezeOverrideCode, freezeOverride.primaryApplFreezeOverrideCode) &&
        Objects.equals(this.secondaryApplFreezeOverrideCode, freezeOverride.secondaryApplFreezeOverrideCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(primaryApplFreezeOverrideCode, secondaryApplFreezeOverrideCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FreezeOverride {\n");
    
    sb.append("    primaryApplFreezeOverrideCode: ").append(toIndentedString(primaryApplFreezeOverrideCode)).append("\n");
    sb.append("    secondaryApplFreezeOverrideCode: ").append(toIndentedString(secondaryApplFreezeOverrideCode)).append("\n");
    sb.append("}");
    return sb.toString();
  }
