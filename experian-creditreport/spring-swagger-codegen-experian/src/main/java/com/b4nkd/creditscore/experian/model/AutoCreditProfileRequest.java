...
import com.b4nkd.creditscore.experian.model.AutoAddons;
...
public class AutoCreditProfileRequest   {
  ...
  @JsonProperty("addOns")
  private AutoAddons addOns = null;

  @JsonProperty("customOptions")
  private CustomOptions customOptions = null;

  public AutoCreditProfileRequest consumerPii(PII consumerPii) {
  ...
  **/
  ...
  public AutoCreditProfileRequest requestor(Requestor requestor) {
  ...
  **/
  ...
  public AutoCreditProfileRequest permissiblePurpose(PermissiblePurpose permissiblePurpose) {
  ...
  **/
  ...
  public AutoCreditProfileRequest resellerInfo(Reseller resellerInfo) {
  ...
  **/
  ...
  public AutoCreditProfileRequest freezeOverride(FreezeOverride freezeOverride) {
  ...
  **/
  ...
  public AutoCreditProfileRequest addOns(AutoAddons addOns) {
    this.addOns = addOns;
    return this;
  }
  ...
  **/
  @ApiModelProperty(value = "")
    ...
    @Valid
    public AutoAddons getAddOns() {
    return addOns;
  }

  public void setAddOns(AutoAddons addOns) {
    this.addOns = addOns;
  }

  public AutoCreditProfileRequest customOptions(CustomOptions customOptions) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AutoCreditProfileRequest autoCreditProfileRequest = (AutoCreditProfileRequest) o;
    return Objects.equals(this.consumerPii, autoCreditProfileRequest.consumerPii) &&
        Objects.equals(this.requestor, autoCreditProfileRequest.requestor) &&
        Objects.equals(this.permissiblePurpose, autoCreditProfileRequest.permissiblePurpose) &&
        Objects.equals(this.resellerInfo, autoCreditProfileRequest.resellerInfo) &&
        Objects.equals(this.freezeOverride, autoCreditProfileRequest.freezeOverride) &&
        Objects.equals(this.addOns, autoCreditProfileRequest.addOns) &&
        Objects.equals(this.customOptions, autoCreditProfileRequest.customOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoCreditProfileRequest {\n");
