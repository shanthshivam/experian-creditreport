...
import com.b4nkd.creditscore.experian.model.TradelineEmp;
...
public class CreditProfileRespForEmploymentInsightData   {
  ...
  private TradelineEmp tradeline = null;

  @JsonProperty("uniqueConsumerIdentifier")
  private UniqueConsumerIdentifier uniqueConsumerIdentifier = null;

  public CreditProfileRespForEmploymentInsightData addressInformation(List<AddressInformationResp> addressInformation) {
    this.addressInformation = addressInformation;
    return this;
  }

  public CreditProfileRespForEmploymentInsightData addAddressInformationItem(AddressInformationResp addressInformationItem) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData consumerAssistanceReferralAddress(ConsumerAssistanceReferralAddress consumerAssistanceReferralAddress) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData consumerIdentity(ConsumerIdentity consumerIdentity) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData directCheck(DirectCheck directCheck) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData employmentInformation(EmploymentInformation employmentInformation) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData fraudShield(FraudShield fraudShield) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData informationalMessage(InformationalMessage informationalMessage) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData inquiry(Inquiry inquiry) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData ofac(OfacResp ofac) {
    this.ofac = ofac;
    return this;
  }
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData summaries(Summaries summaries) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData publicRecord(PublicRecord publicRecord) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData ssn(Ssn ssn) {
    this.ssn = ssn;
    return this;
  }
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData statement(Statement statement) {
  ...
  **/
  ...
  public CreditProfileRespForEmploymentInsightData tradeline(TradelineEmp tradeline) {
  ...
  **/
  @ApiModelProperty(value = "")
    ...
    @Valid
    public TradelineEmp getTradeline() {
    return tradeline;
  }

  public void setTradeline(TradelineEmp tradeline) {
    this.tradeline = tradeline;
  }

  public CreditProfileRespForEmploymentInsightData uniqueConsumerIdentifier(UniqueConsumerIdentifier uniqueConsumerIdentifier) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditProfileRespForEmploymentInsightData creditProfileRespForEmploymentInsightData = (CreditProfileRespForEmploymentInsightData) o;
    return Objects.equals(this.addressInformation, creditProfileRespForEmploymentInsightData.addressInformation) &&
        Objects.equals(this.consumerAssistanceReferralAddress, creditProfileRespForEmploymentInsightData.consumerAssistanceReferralAddress) &&
        Objects.equals(this.consumerIdentity, creditProfileRespForEmploymentInsightData.consumerIdentity) &&
        Objects.equals(this.directCheck, creditProfileRespForEmploymentInsightData.directCheck) &&
        Objects.equals(this.employmentInformation, creditProfileRespForEmploymentInsightData.employmentInformation) &&
        Objects.equals(this.fraudShield, creditProfileRespForEmploymentInsightData.fraudShield) &&
        Objects.equals(this.informationalMessage, creditProfileRespForEmploymentInsightData.informationalMessage) &&
        Objects.equals(this.inquiry, creditProfileRespForEmploymentInsightData.inquiry) &&
        Objects.equals(this.ofac, creditProfileRespForEmploymentInsightData.ofac) &&
        Objects.equals(this.summaries, creditProfileRespForEmploymentInsightData.summaries) &&
        Objects.equals(this.publicRecord, creditProfileRespForEmploymentInsightData.publicRecord) &&
        Objects.equals(this.ssn, creditProfileRespForEmploymentInsightData.ssn) &&
        Objects.equals(this.statement, creditProfileRespForEmploymentInsightData.statement) &&
        Objects.equals(this.tradeline, creditProfileRespForEmploymentInsightData.tradeline) &&
        Objects.equals(this.uniqueConsumerIdentifier, creditProfileRespForEmploymentInsightData.uniqueConsumerIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressInformation, consumerAssistanceReferralAddress, consumerIdentity, directCheck, employmentInformation, fraudShield, informationalMessage, inquiry, ofac, summaries, publicRecord, ssn, statement, tradeline, uniqueConsumerIdentifier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreditProfileRespForEmploymentInsightData {\n");
